...
// Version that changes speed in corners based on actual acceleration
    ...
    if(state == 1){ // Fast driving 
        ...
        switch(current_section.type){
            ...
            case CORNER:
                ...
                // Speed in corner is calculated from actual acceleration
                // Values are set experimentally, these are the best ones
